...
class Transformer(nn.Module):
    ...
    def __init__(self, d_model=512, nhead=8, num_encoder_layers=6,
                 ...
                 activation="relu", normalize_before=False, decoder_input_len=3600,
    ...
    def forward(self, src, fea, pos_embed):
        ...
        # memory= torch.zeros_like(memory).cuda()
        # memory=memory[0].unsqueeze(0)
        # memory = torch.repeat_interleave(memory, repeats=16, dim=0)
        # '''
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, encoder_layer, num_layers, norm=None, hidden_dim=512):
        super().__init__()
