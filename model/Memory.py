...
#                     query_update[i] = torch.sum(query[idx].squeeze(1), dim=0)
    ...
    def forward(self, query, keys, train=True):
        ...
        if train:
            ...
            # print("updated_query:",updated_query.shape)
            #update
        ...
        #test
            ...
            return updated_query, updated_memory, softmax_score_query, softmax_score_memory, gathering_loss,None
    ...
    def read(self, query, updated_memory):
        ...
        # updated_query = torch.cat((query_reshape, concat_memory), dim = 1) # (b X h X w) X 2d # ori

        updated_query = concat_memory #[128, 512]
        # updated_query = updated_query.view(batch_size, h, w, 2*dims) # ori
        updated_query = updated_query.view(batch_size, h, w, 1*dims)
