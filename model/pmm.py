...
class PMMs(nn.Module):
    ...
    def forward(self, support_feature):
        prototypes, z_,mu_f,mu_b = self.generate_prototype(support_feature)
        P_b,P_f, P = self.discriminative_model(support_feature, mu_f, mu_b)

        return prototypes, z_, P_b,P_f
